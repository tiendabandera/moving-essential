const ButtonSvg2 = (orange) => (
  <>
    ...
    >
      <path
        fill={orange ? "orange" : "none"}
        stroke={orange ? "orange" : "url(#btn-left)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
    ...
    >
      <path
        fill={orange ? "orange" : "none"}
        stroke={orange ? "orange" : "url(#btn-right)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
