    ...
    <div className=" bg-white px-10 py-20 rounded-3xl border-2 border-gray-100">
      ...
      <div className="mt-8">
        <div className='mt-2'>
          {
            loginErrors.map((error, i) => (
              <div key={i} className='bg-red-500 p-2 text-white rounded-xl'>{error}</div>
            ))
          }
        </div>
        <div className="mt-2">
          ...
          />
          {
            showErrors.email && errors.email && <span className="text-red-500 font-medium text-sm">Email is required</span>
          }
        </div>
        <div className="mt-2">
          ...
          />
          {
            showErrors.password && errors.password && <span className="text-red-500 font-medium text-sm">Password is required</span>
          }
        </div>
        ...
        <div className="mt-8 flex justify-center items-center gap-x-2">
          ...
          <button className="font-medium text-base text-orange-600" onClick={() => navigate('/register')}>
            Sign up
          </button>
        </div>
      </div>
