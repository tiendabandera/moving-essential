...
const features = [
  {
    ...
    description:
      "Our platform connects you with trusted local realtors based on your specific needs and preferences. Say goodbye to the hassle of searching for “realtors near me” – we’ve got you covered. Find the perfect agent to guide you through buying or selling your property with ease and confidence.",
  },
  {
...
const ComparePage = () => {
  return (
    <div>
      <Section
        classNameParent={
          "z-[10] relative -mt-1 lg:mt-0 py-20 bg-[url('/assets/img/compare-realtors.jpg')] bg-cover bg-bottom bg-no-repeat before:absolute before:inset-0 before:bg-black/70"
        }
      ...
      >
        ...
        <div className="flex flex-col gap-5 xl:w-1/2">
          <div className="flex flex-col">
            <h1 className="bold-52 lg:bold-88 text-white ">Realtors</h1>
          ...
          <p className="regular-16 text-white font-extralight text-justify ">
            At Moving Essential, we understand that finding the right real
            estate agents in South Florida can be a daunting process. Whether
            you’re relocating within Florida or moving to the Sunshine State for
            the first time, partnering with experienced realtor real estate
            agents is crucial for a seamless transition. That’s why we’re
            dedicated to connecting you with reputable professionals who have a
            deep understanding of the local market, ensuring you have the
                ...
                <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                  ...
                  <div className="mt-15 flex flex-col gap-2">
                    <h4 className="text-xl font-semibold text-gray-900">
                      Find Realtors with Proven Expertise
                    </h4>
                    <p className="text-pretty !text-sm font-light text-gray-950/75 sm:max-w-md sm:text-xl/8 lg:max-w-none">
                      Our network includes experienced agents specializing in
                      various aspects of real estate, from residential
                      properties to commercial spaces. They are well-versed in
                      the latest market trends and property values and provide
                  ...
                  <div className="mt-15 flex flex-col gap-2">
                    ...
                    <p className="text-pretty !text-sm font-light text-gray-950/75 sm:max-w-md sm:text-xl/8 lg:max-w-none">
                      From initial consultations to final closings, our network
                      of real estate agents near me provides comprehensive
                      support, handling paperwork, negotiations, and any
                      unexpected hurdles that may arise
                    </p>
                  </div>
                </div>
                <div className="mt-14 flex justify-end gap-8 sm:-mt-44 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0">
                  <div className="ml-auto w-44 flex-none space-y-8 pt-32 sm:ml-0 sm:pt-80 lg:order-last lg:pt-36 xl:order-none xl:pt-80">
                    <div className="relative">
                      <img
                        ...
                        src="/assets/img/realtor/compare-2.jpg"
                  ...
                  <div className="mr-auto w-44 flex-none space-y-8 sm:mr-0 sm:pt-52 lg:pt-36">
                    <div className="relative">
                      <img
                        alt="Compare Residential Local Moving"
                        src="/assets/img/realtor/compare-3.jpg"
                        className="aspect-2/3 w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                      />
                      <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-gray-900/10 ring-inset" />
                    </div>
                    <div className="relative">
                      <img
                        alt="Compare Residential Local Moving"
                        src="/assets/img/realtor/compare-4.jpg"
                        className="aspect-2/3 w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                      />
                      <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-gray-900/10 ring-inset" />
                    </div>
                  ...
                  <div className="w-44 flex-none space-y-8 pt-32 sm:pt-0">
                    <div className="relative">
                      <img
                        alt="Compare Residential Local Moving"
                        src="/assets/img/realtor/compare-1.jpg"
                        className="aspect-2/3 w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                      />
                      <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-gray-900/10 ring-inset" />
                    </div>
                    <div className="relative">
                      <img
                        alt="Compare Residential Local Moving"
                        src="/assets/img/realtor/compare-5.jpg"
                        className="aspect-2/3 w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                      />
                      <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-gray-900/10 ring-inset" />
                    </div>
      ...
      <Section classNameParent={"pb-16"}>
        <h3 className="bold-40 lg:bold-64 tracking-tight text-pretty text-gray-900 lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
          Work With Realtors in South Florida
        </h3>
