  ...
  return (
    <div className="padding-container w-full flex flex-col gap-24 my-10 md:my-24">
      ...
      <section className="flex-center w-full flex-col">
        <div className="get-app-landing flex-col md:flex-row items-center p-6 sm:px-28 md:px-12">
          <div className="flex flex-col gap-12">
            <h2 className="text-center font-bold text-4xl md:text-5xl xl:text-6xl md:text-left xl:max-w-2xl text-pretty leading-tight">
      ...
      <section className="relative max-container w-full py-20 flex items-center flex-col gap-10">
        ...
        <h2 className="text-color-1 text-3xl lg:text-4xl font-bold sm:max-w-2xl lg:max-w-3xl xl:max-w-4xl text-center">
          Moving Essential is the go-to platform for future homeowners looking
          for a trusted realtor.
        </h2>
        <h2 className="text-3xl lg:text-4xl font-bold sm:max-w-2xl lg:max-w-3xl xl:max-w-4xl text-center">
      ...
      <section className="max-container flex items-center w-full gap-5">
        <div className="get-app-landing-2 flex-row p-8 xl:p-10 !items-center justify-center mt-auto lg:items-start h-[470px] max-h-[500px] xl:h-[450px]">
        ...
        <img
          src="/assets/img/landing-realtor-3.png"
          className="hidden lg:block w-[50%] lg:h-[520px] xl:w-1/2 mt-auto xl:h-[500px]"
          alt=""
        />
      </section>
      {/* Section 6 */}
      ...
      <section className="w-full flex flex-col">
        <div className="get-app-landing-3 lg:h-[450px] flex-col items-center justify-center p-10 sm:px-20 sm:py-20 md:pb-0 xl:pt-10">
