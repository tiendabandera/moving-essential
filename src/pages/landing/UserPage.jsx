...
const UserPage = () => {
  ...
  return (
    <div className="padding-container-2 w-full flex flex-col gap-24 py-10 md:py-24">
      {/* Section 1 */}
      <section className="flex-center w-full flex-col">
        <div className="get-app-landing flex-col items-center p-10 md:flex-row">
          <div className="flex flex-col items-center gap-5 md:gap-12">
            {/* <h2 className="text-center title-landing leading-tight lg:text-left md:text-4xl lg:text-5xl xl:text-6xl xl:max-w-xl">
              Compare Top Moving Services & Realtors <br />
            ...
            <Button
              className=" bg-purple-500 text-color-1 border border-purple-500 rounded-2xl hover:bg-purple-100 hover:text-purple-500"
              onClick={() => navigate("/")}
            >
              See more
            </Button>
      ...
      <section className="relative max-container w-full py-20 flex flex-center flex-col gap-10">
        ...
        />
        <h2 className="text-center title-landing leading-tight sm:max-w-2xl lg:max-w-3xl xl:max-w-6xl">
          Save time and money by instantly comparing prices, and verified
          ratings.
        </h2>
        <p className="md:text-xl font-medium text-color-1 text-center">
      ...
      <section className="relative max-container  w-full py-20 flex flex-center flex-col gap-10">
        ...
        <div className="w-full flex flex-col gap-4">
          <h2 className="title-landing">User benefits</h2>
