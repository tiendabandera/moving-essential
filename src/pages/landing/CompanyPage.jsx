  ...
  return (
    <div className="padding-container w-full flex flex-col gap-24 my-10 md:my-24">
      ...
      <section className="flex flex-col w-full">
        <div className="get-app-landing flex-col gap-y-4 md:flex-row items-center p-10 px-10 !pt-0 sm:py-20 sm:pb-0 xl:px-20">
          <div className="mt-10 md:pb-10 flex flex-col items-center gap-5 lg:gap-12">
            <h2 className="text-center title-landing md:max-w-xl text-pretty leading-tight">
          ...
          <img
            ...
            className="hidden sm:block w-[50%] md:w-[40%] lg:w-1/2 mt-auto"
            alt=""
          />
        </div>
      </section>
      ...
      <section className="max-container flex items-center w-full gap-5">
        <div className="get-app-landing-2 flex-row p-8 xl:p-10 !items-center justify-center mt-auto lg:items-start lg:h-[320px] xl:h-[405px]">
        ...
        <img
          src="/assets/img/landing-company-2.png"
          className="hidden mt-auto lg:block w-[50%] lg:h-[340px] xl:w-1/2 xl:h-[430px]"
          alt=""
        />
      </section>
      {/* Section 4 */}
      <section className="max-container flex items-center w-full gap-5">
        <img
          ...
          alt=""
        />
        <div className="get-app-landing flex-row p-8 xl:p-10 !items-center justify-center mt-auto lg:items-start lg:h-[320px] xl:h-[405px]">
          <div className="w-full flex flex-col gap-8 xl:gap-10">
            <h2 className="title-landing text-white leading-none">
              How does it work?
            </h2>
            <ul className="text-white text-md space-y-2 lg:text-lg xl:space-y-4">
              <li className="flex items-center gap-2">
      ...
      <section className="flex-center w-full flex-col">
        <div className="get-app-landing flex-col gap-5 lg:gap-20 md:flex-row items-center max-h-none !py-10  md:px-10">
          <FAQs title="FAQs for Movers" options={faqs} />
          <img
            src="/assets/img/landing-company-4.png"
            className="hidden md:block md:w-[50%] lg:w-[40%]"
            alt=""
          />
        </div>
      </section>
