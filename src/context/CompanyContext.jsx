...
export class Company extends BaseModel {
  ...
  // async getAllByBusinessTypeQueryParamsOld(
  //   offset,
  //   businessTypeId,
  //   filterParams,
  //   offsetFeatures
  ...
  //   this.test(
  //     await supabase.rpc("get_unique_companies_local_moving", {
  //       ...filterParams,
  //       offset_count: offset,
  //     })
  //   );
  ...
  async getAllByBusinessTypeQueryParams(
    ...
    const functionName = businessTypeId === 1 ? "local_moving" : "realtors";

    const { data, error } = await supabase.rpc(
      `get_unique_companies_${functionName}`,
      {
        ...filterParams,
        offset_count: offset,
      }
    ...
    console.log(
      data.map((item) => {
        const { service, cities, cities_2, company, ...rest } = item.result;
        return { ...company, service, cities, cities_2, ...rest };
      })
    );
    ...
    return {
      ...
      error: error,
      newOffsetFeatures: offsetFeatures,
    };
  }
